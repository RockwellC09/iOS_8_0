...
{$linkframework NewsstandKit}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesNewsstandKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesNewsstandKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include newsstandkit/UndefinedTypes.inc}

{$define TYPES}
{$include newsstandkit/Sources.inc}
{$undef TYPES}
...
{$include newsstandkit/InlineFunctions.inc}
