...
unit NotificationCenter;
interface

{$linkframework NotificationCenter}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesNotificationCenter, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesNotificationCenter, UIKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include notificationcenter/UndefinedTypes.inc}

{$define TYPES}
{$include notificationcenter/Sources.inc}
{$undef TYPES}
...
{$include notificationcenter/InlineFunctions.inc}
