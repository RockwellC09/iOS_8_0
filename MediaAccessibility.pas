...
unit MediaAccessibility;
interface

{$linkframework MediaAccessibility}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesMediaAccessibility, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesMediaAccessibility, CoreGraphics, CoreText, QuartzCore, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include mediaaccessibility/UndefinedTypes.inc}

{$define TYPES}
{$include mediaaccessibility/Sources.inc}
{$undef TYPES}
...
{$include mediaaccessibility/InlineFunctions.inc}
