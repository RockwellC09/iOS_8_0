...
{$linkframework CoreMotion}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreMotion, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreMotion, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include coremotion/UndefinedTypes.inc}

{$define TYPES}
{$include coremotion/Sources.inc}
{$undef TYPES}
...
{$include coremotion/InlineFunctions.inc}
