...
{$linkframework GameKit}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesGameKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesGameKit, UIKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include gamekit/UndefinedTypes.inc}

{$define TYPES}
{$include gamekit/Sources.inc}
{$undef TYPES}
...
{$include gamekit/InlineFunctions.inc}
