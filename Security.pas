...
{$modeswitch cvar}
{$ifdef IPHONEALL}
{$fatal "Security can't be used because -dIPHONEALL has been declared."}
{$endif}
...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesSecurity, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesSecurity, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
