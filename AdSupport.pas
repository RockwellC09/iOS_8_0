...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesAdSupport, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesAdSupport, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include adsupport/UndefinedTypes.inc}

{$define TYPES}
{$include adsupport/Sources.inc}
{$undef TYPES}
...
{$include adsupport/InlineFunctions.inc}
