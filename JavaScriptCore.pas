...
{$linkframework JavaScriptCore}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesJavaScriptCore, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesJavaScriptCore, CoreGraphics, CoreFoundation, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include javascriptcore/UndefinedTypes.inc}

{$define TYPES}
{$include javascriptcore/Sources.inc}
{$undef TYPES}
...
{$include javascriptcore/InlineFunctions.inc}
