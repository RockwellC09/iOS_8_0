...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesFoundation, DefinedClassesEventKit, CoreLocation, AddressBook, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesFoundation, DefinedClassesEventKit, Foundation, CoreLocation, AddressBook, CoreGraphics, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include eventkit/UndefinedTypes.inc}

{$define TYPES}
{$include eventkit/Sources.inc}
{$undef TYPES}
...
{$include eventkit/InlineFunctions.inc}
