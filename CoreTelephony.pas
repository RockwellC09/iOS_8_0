...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreTelephony, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreTelephony, Foundation, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include coretelephony/UndefinedTypes.inc}

{$define TYPES}
{$include coretelephony/Sources.inc}
{$undef TYPES}
...
{$include coretelephony/InlineFunctions.inc}
