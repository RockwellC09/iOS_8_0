...
{$linkframework AddressBookUI}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreFoundation, DefinedClassesFoundation, DefinedClassesAddressBookUI, AddressBook, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreFoundation, DefinedClassesFoundation, DefinedClassesAddressBookUI, CoreFoundation, Foundation, UIKit, AddressBook, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include addressbookui/UndefinedTypes.inc}

{$define TYPES}
{$include addressbookui/Sources.inc}
{$undef TYPES}
...
{$include addressbookui/InlineFunctions.inc}
