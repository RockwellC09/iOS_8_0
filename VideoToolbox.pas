...
{$linkframework VideoToolbox}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesVideoToolbox, CoreVideo, CoreMedia, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesVideoToolbox, CoreVideo, CoreFoundation, CoreMedia, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include videotoolbox/UndefinedTypes.inc}

{$define TYPES}
{$include videotoolbox/Sources.inc}
{$undef TYPES}
...
{$include videotoolbox/InlineFunctions.inc}
