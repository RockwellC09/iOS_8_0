...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreMedia, CoreVideo, AudioToolbox, CoreAudio, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreMedia, CoreVideo, CoreGraphics, AudioToolbox, CoreAudio, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
