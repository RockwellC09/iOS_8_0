...
{$linkframework PushKit}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesPushKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesPushKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include pushkit/UndefinedTypes.inc}

{$define TYPES}
{$include pushkit/Sources.inc}
{$undef TYPES}
...
{$include pushkit/InlineFunctions.inc}
