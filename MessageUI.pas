...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesFoundation, DefinedClassesMessageUI, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesFoundation, DefinedClassesMessageUI, Foundation, UIKit, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include messageui/UndefinedTypes.inc}

{$define TYPES}
{$include messageui/Sources.inc}
{$undef TYPES}
...
{$include messageui/InlineFunctions.inc}
