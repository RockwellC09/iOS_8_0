...
{$linkframework GameController}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesGameController, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesGameController, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include gamecontroller/UndefinedTypes.inc}

{$define TYPES}
{$include gamecontroller/Sources.inc}
{$undef TYPES}
...
{$include gamecontroller/InlineFunctions.inc}
