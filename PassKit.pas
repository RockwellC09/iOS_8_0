...
{$linkframework PassKit}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesPassKit, AddressBook, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesPassKit, AddressBook, UIKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include passkit/UndefinedTypes.inc}

{$define TYPES}
{$include passkit/Sources.inc}
{$undef TYPES}
...
{$include passkit/InlineFunctions.inc}
