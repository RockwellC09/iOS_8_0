...
{$linkframework WatchKit}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesWatchKit, MapKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesWatchKit, MapKit, UIKit, CoreGraphics, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include watchkit/UndefinedTypes.inc}

{$define TYPES}
{$include watchkit/Sources.inc}
{$undef TYPES}
...
{$include watchkit/InlineFunctions.inc}
