...
unit NetworkExtension;
interface

{$linkframework NetworkExtension}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesNetworkExtension, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesNetworkExtension, Security, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include networkextension/UndefinedTypes.inc}

{$define TYPES}
{$include networkextension/Sources.inc}
{$undef TYPES}
...
{$include networkextension/InlineFunctions.inc}
