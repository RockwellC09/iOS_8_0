...
{$modeswitch cvar}
{$ifdef IPHONEALL}
{$fatal "QuartzCore can't be used because -dIPHONEALL has been declared."}
{$endif}
...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreImage, DefinedClassesFoundation, DefinedClassesQuartzCore, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreImage, DefinedClassesFoundation, DefinedClassesQuartzCore, CoreImage, Foundation, OpenGLES, CoreGraphics, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
