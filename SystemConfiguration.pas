...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesSystemConfiguration, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesSystemConfiguration, Foundation, Security, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include systemconfiguration/UndefinedTypes.inc}

{$define TYPES}
{$include systemconfiguration/Sources.inc}
{$undef TYPES}
...
{$include systemconfiguration/InlineFunctions.inc}
