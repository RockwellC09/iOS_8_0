...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesEventKit, DefinedClassesFoundation, DefinedClassesEventKitUI, EventKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesEventKit, DefinedClassesFoundation, DefinedClassesEventKitUI, EventKit, Foundation, UIKit, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include eventkitui/UndefinedTypes.inc}

{$define TYPES}
{$include eventkitui/Sources.inc}
{$undef TYPES}
...
{$include eventkitui/InlineFunctions.inc}
