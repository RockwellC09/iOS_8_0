...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesAudioToolbox, CoreMIDI, AudioUnit, CoreAudio, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesAudioToolbox, CoreMIDI, AudioUnit, CoreFoundation, CoreAudio, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include audiotoolbox/UndefinedTypes.inc}

{$define TYPES}
{$include audiotoolbox/Sources.inc}
{$undef TYPES}
...
{$include audiotoolbox/InlineFunctions.inc}
