...
{$linkframework MapKit}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreFoundation, DefinedClassesMapKit, CoreLocation, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreFoundation, DefinedClassesMapKit, CoreFoundation, UIKit, CoreLocation, CoreGraphics, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include mapkit/UndefinedTypes.inc}

{$define TYPES}
{$include mapkit/Sources.inc}
{$undef TYPES}
...
{$include mapkit/InlineFunctions.inc}
