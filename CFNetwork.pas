...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCFNetwork, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCFNetwork, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include cfnetwork/UndefinedTypes.inc}

{$define TYPES}
{$include cfnetwork/Sources.inc}
{$undef TYPES}
...
{$include cfnetwork/InlineFunctions.inc}
