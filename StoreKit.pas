...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesStoreKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesStoreKit, UIKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include storekit/UndefinedTypes.inc}

{$define TYPES}
{$include storekit/Sources.inc}
{$undef TYPES}
...
{$include storekit/InlineFunctions.inc}
