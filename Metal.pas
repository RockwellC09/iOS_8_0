...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesMetal, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesMetal, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include metal/UndefinedTypes.inc}

{$define TYPES}
{$include metal/Sources.inc}
{$undef TYPES}
...
{$include metal/InlineFunctions.inc}
