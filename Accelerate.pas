...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesAccelerate, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesAccelerate, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include accelerate/UndefinedTypes.inc}

{$define TYPES}
{$include accelerate/Sources.inc}
{$undef TYPES}
...
{$include accelerate/InlineFunctions.inc}
