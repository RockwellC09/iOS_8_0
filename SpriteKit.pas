...
{$linkframework SpriteKit}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesSpriteKit, GLKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesSpriteKit, GLKit, UIKit, QuartzCore, Foundation, CoreGraphics, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include spritekit/UndefinedTypes.inc}

{$define TYPES}
{$include spritekit/Sources.inc}
{$undef TYPES}
...
{$include spritekit/InlineFunctions.inc}
