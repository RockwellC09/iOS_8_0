...
{$linkframework HomeKit}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesHomeKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesHomeKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include homekit/UndefinedTypes.inc}

{$define TYPES}
{$include homekit/Sources.inc}
{$undef TYPES}
...
{$include homekit/InlineFunctions.inc}
