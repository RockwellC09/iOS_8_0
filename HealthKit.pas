...
{$linkframework HealthKit}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesHealthKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesHealthKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include healthkit/UndefinedTypes.inc}

{$define TYPES}
{$include healthkit/Sources.inc}
{$undef TYPES}
...
{$include healthkit/InlineFunctions.inc}
