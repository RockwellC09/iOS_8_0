...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreFoundation, DefinedClassesCoreBluetooth, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreFoundation, DefinedClassesCoreBluetooth, CoreFoundation, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
