...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreMIDI, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreMIDI, Foundation, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include coremidi/UndefinedTypes.inc}

{$define TYPES}
{$include coremidi/Sources.inc}
{$undef TYPES}
...
{$include coremidi/InlineFunctions.inc}
