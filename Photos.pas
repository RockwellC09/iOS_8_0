...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesPhotos, AVFoundation, ImageIO, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesPhotos, AVFoundation, ImageIO, UIKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include photos/UndefinedTypes.inc}

{$define TYPES}
{$include photos/Sources.inc}
{$undef TYPES}
...
{$include photos/InlineFunctions.inc}
