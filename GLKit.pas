...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesGLKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesGLKit, CoreGraphics, CoreFoundation, OpenGLES, UIKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include glkit/UndefinedTypes.inc}

{$define TYPES}
{$include glkit/Sources.inc}
{$undef TYPES}
...
{$include glkit/InlineFunctions.inc}
