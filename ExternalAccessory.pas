...
unit ExternalAccessory;
interface

{$linkframework ExternalAccessory}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesFoundation, DefinedClassesExternalAccessory, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesFoundation, DefinedClassesExternalAccessory, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include externalaccessory/UndefinedTypes.inc}

{$define TYPES}
{$include externalaccessory/Sources.inc}
{$undef TYPES}
...
{$include externalaccessory/InlineFunctions.inc}
