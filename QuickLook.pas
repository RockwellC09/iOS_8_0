...
{$linkframework QuickLook}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreGraphics, DefinedClassesQuickLook, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreGraphics, DefinedClassesQuickLook, CoreGraphics, Foundation, UIKit, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include quicklook/UndefinedTypes.inc}

{$define TYPES}
{$include quicklook/Sources.inc}
{$undef TYPES}
...
{$include quicklook/InlineFunctions.inc}
