...
{$linkframework Twitter}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesTwitter, Social, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesTwitter, UIKit, Social, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include twitter/UndefinedTypes.inc}

{$define TYPES}
{$include twitter/Sources.inc}
{$undef TYPES}
...
{$include twitter/InlineFunctions.inc}
