...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesMediaPlayer, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesMediaPlayer, UIKit, CoreGraphics, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include mediaplayer/UndefinedTypes.inc}

{$define TYPES}
{$include mediaplayer/Sources.inc}
{$undef TYPES}
...
{$include mediaplayer/InlineFunctions.inc}
