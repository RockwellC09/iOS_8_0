...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesSafariServices, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesSafariServices, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include safariservices/UndefinedTypes.inc}

{$define TYPES}
{$include safariservices/Sources.inc}
{$undef TYPES}
...
{$include safariservices/InlineFunctions.inc}
