...
unit LocalAuthentication;
interface

{$linkframework LocalAuthentication}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesLocalAuthentication, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesLocalAuthentication, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include localauthentication/UndefinedTypes.inc}

{$define TYPES}
{$include localauthentication/Sources.inc}
{$undef TYPES}
...
{$include localauthentication/InlineFunctions.inc}
