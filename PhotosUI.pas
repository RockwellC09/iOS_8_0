...
{$linkframework PhotosUI}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesPhotosUI, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesPhotosUI, UIKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include photosui/UndefinedTypes.inc}

{$define TYPES}
{$include photosui/Sources.inc}
{$undef TYPES}
...
{$include photosui/InlineFunctions.inc}
