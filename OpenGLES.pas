...
{$modeswitch cvar}
{$ifdef IPHONEALL}
{$fatal "OpenGLES can't be used because -dIPHONEALL has been declared."}
{$endif}
...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesOpenGLES, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesOpenGLES, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
