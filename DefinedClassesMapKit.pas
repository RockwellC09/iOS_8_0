...
type
  ...
  MKOverlayPathView = objcclass external;
  MKOverlayRenderer = objcclass external;
  MKOverlayView = objcclass external;
  ...
  MKPolygonView = objcclass external;
  MKPolyline = objcclass external;
  MKPolylineRenderer = objcclass external;
  MKPolylineView = objcclass external;
  MKReverseGeocoder = objcclass external;
  ...
  MKUserTrackingBarButtonItem = objcclass external;
  ...
  MKReverseGeocoderDelegateProtocol = objcprotocol external name 'MKReverseGeocoderDelegate';
