...
{$modeswitch cvar}
{$ifdef IPHONEALL}
{$fatal "UIKit can't be used because -dIPHONEALL has been declared."}
{$endif}
...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreFoundation, DefinedClassesFoundation, DefinedClassesUIKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreFoundation, DefinedClassesFoundation, DefinedClassesUIKit, CoreFoundation, Foundation, QuartzCore, CoreText, CoreImage, CoreGraphics, CTypes, MacTypes, MacOSXPosix;
{$endif}
