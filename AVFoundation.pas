...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesAVFoundation, MediaToolbox, CoreVideo, CoreMedia, AudioUnit, AudioToolbox, CoreAudio, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesAVFoundation, QuartzCore, MediaToolbox, CoreVideo, CoreMedia, CoreGraphics, CoreFoundation, AudioUnit, AudioToolbox, CoreAudio, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
