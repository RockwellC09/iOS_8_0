...
{$linkframework Social}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesSocial, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesSocial, UIKit, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include social/UndefinedTypes.inc}

{$define TYPES}
{$include social/Sources.inc}
{$undef TYPES}
...
{$include social/InlineFunctions.inc}
