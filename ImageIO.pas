...
{$linkframework ImageIO}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesImageIO, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesImageIO, CoreGraphics, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include imageio/UndefinedTypes.inc}

{$define TYPES}
{$include imageio/Sources.inc}
{$undef TYPES}
...
{$include imageio/InlineFunctions.inc}
