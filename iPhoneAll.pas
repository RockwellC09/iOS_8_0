...
{$ifndef IPHONEALL}
{$error "You must compile with -dIPHONEALL to use IPHONEALL."}
{$endif}
...
{$define FRAMEWORK_LOADED_COREFOUNDATION}
{$define FRAMEWORK_LOADED_SECURITY}
...
{$define FRAMEWORK_LOADED_CORETEXT}
{$define FRAMEWORK_LOADED_QUARTZCORE}
{$define FRAMEWORK_LOADED_UIKIT}
{$define FRAMEWORK_LOADED_MOBILECORESERVICES}

{$include UndefinedTypes.inc}
{$include corefoundation/UndefinedTypes.inc}
{$include security/UndefinedTypes.inc}
{$include foundation/UndefinedTypes.inc}
{$include coregraphics/UndefinedTypes.inc}
{$include opengles/UndefinedTypes.inc}
{$include coreimage/UndefinedTypes.inc}
{$include coretext/UndefinedTypes.inc}
{$include quartzcore/UndefinedTypes.inc}
{$include uikit/UndefinedTypes.inc}
{$include mobilecoreservices/UndefinedTypes.inc}

{$define TYPES}
{$include corefoundation/Sources.inc}
{$include security/Sources.inc}
{$include foundation/Sources.inc}
{$include coregraphics/Sources.inc}
{$include opengles/Sources.inc}
{$include coreimage/Sources.inc}
{$include coretext/Sources.inc}
{$include quartzcore/Sources.inc}
{$include uikit/Sources.inc}
{$include mobilecoreservices/Sources.inc}
{$undef TYPES}
...
{$include security/InlineFunctions.inc}
{$include foundation/InlineFunctions.inc}
{$include coregraphics/InlineFunctions.inc}
{$include opengles/InlineFunctions.inc}
{$include coreimage/InlineFunctions.inc}
{$include coretext/InlineFunctions.inc}
{$include quartzcore/InlineFunctions.inc}
{$include uikit/InlineFunctions.inc}
{$include mobilecoreservices/InlineFunctions.inc}
