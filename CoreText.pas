...
{$modeswitch cvar}
{$ifdef IPHONEALL}
{$fatal "CoreText can't be used because -dIPHONEALL has been declared."}
{$endif}
...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreText, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreText, CoreGraphics, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
