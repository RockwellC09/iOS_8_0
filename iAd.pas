...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreGraphics, DefinedClassesiAd, AVKit, MediaPlayer, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreGraphics, DefinedClassesiAd, CoreGraphics, AVKit, MediaPlayer, Foundation, UIKit, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include iad/UndefinedTypes.inc}

{$define TYPES}
{$include iad/Sources.inc}
{$undef TYPES}
...
{$include iad/InlineFunctions.inc}
