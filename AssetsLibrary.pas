...
{$linkframework AssetsLibrary}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesAssetsLibrary, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesAssetsLibrary, CoreGraphics, Foundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include assetslibrary/UndefinedTypes.inc}

{$define TYPES}
{$include assetslibrary/Sources.inc}
{$undef TYPES}
...
{$include assetslibrary/InlineFunctions.inc}
