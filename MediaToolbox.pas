...
{$linkframework MediaToolbox}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreAudio, DefinedClassesMediaToolbox, CoreAudio, AudioToolbox, CoreMedia, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreAudio, DefinedClassesMediaToolbox, CoreAudio, AudioToolbox, CoreMedia, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include mediatoolbox/UndefinedTypes.inc}

{$define TYPES}
{$include mediatoolbox/Sources.inc}
{$undef TYPES}
...
{$include mediatoolbox/InlineFunctions.inc}
