...
{$linkframework SceneKit}

uses
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesSceneKit, JavaScriptCore, GLKit, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesSceneKit, JavaScriptCore, UIKit, Foundation, GLKit, QuartzCore, CTypes, MacTypes, MacOSXPosix;
{$endif}
...
{$include scenekit/UndefinedTypes.inc}

{$define TYPES}
{$include scenekit/Sources.inc}
{$undef TYPES}
...
{$include scenekit/InlineFunctions.inc}
