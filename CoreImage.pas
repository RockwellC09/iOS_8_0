...
{$modeswitch cvar}
{$ifdef IPHONEALL}
{$fatal "CoreImage can't be used because -dIPHONEALL has been declared."}
{$endif}
...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesFoundation, DefinedClassesCoreImage, CoreVideo, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesFoundation, DefinedClassesCoreImage, Foundation, OpenGLES, CoreVideo, CoreGraphics, CTypes, MacTypes, MacOSXPosix, CoreFoundation;
{$endif}
