...
{$if defined(IPHONEALL) and not defined(GROUP_INDEPENDENT)}
	 DefinedClassesCoreVideo, Metal, CTypes, MacTypes, MacOSXPosix, iPhoneAll;
{$else}
	 DefinedClassesCoreVideo, Metal, OpenGLES, CoreGraphics, CoreFoundation, CTypes, MacTypes, MacOSXPosix;
{$endif}
